          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                }} className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm" id="amount" placeholder="Enter a Amount">
                </input>
              </div>
                ...
                if(response.status == 200){
                  ...
                  navigate("/TransactionUnsuccessful")
                }
